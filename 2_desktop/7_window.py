...
# fw = pyautogui.getActiveWindow() # 현재 활성화된 창 정보 가져오기 (VScode)
# print(fw.title) # 창의 제목 정보 가져오기
# print(fw.size) # 창의 크기 정보 (width, height) 가져오기
...
## 제목 없음 윈도우 다 가져오기
# for w in pyautogui.getWindowsWithTitle("채널"):
#     print(w)


# w = pyautogui.getWindowsWithTitle("파일 탐색기")[0]
# print(w)
